...
async function btnfunction(isall) {
    ...
    let showAllBtn = document.getElementsByClassName("eJCyWD");
    ...
    const liveElements = document.getElementsByClassName("hTcwfL");
    const liveElementsHearts = document.getElementsByClassName("WlKBJ");
...
function placebtn() {
    ...
    const btn1 = document.getElementsByClassName("sc-51741bbe-0 bXChhg")[0];
    const btn2 = document.getElementsByClassName("charcoal-pagination-nav-button")[1];
    const btnSearch = document.getElementsByClassName("ddVNOy")[0];
...
function btnHideLiked() {
    let likedImages = document.getElementsByClassName("fCeVXK");
